...
En esta carpeta del repositorio del curso pueden ver un `index.html` además de una carpeta `/img` que contiene una única imagen. Esto es un ejemplo que se inspira en un trabajo de Reuters Graphics y reutiliza algo de JavaScript escrito en clases pasadas: 
