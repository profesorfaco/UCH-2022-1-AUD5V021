...
- **Hasta 4 puntos** por avance de implementación de la portada del sitio web, a revisar en las semana del martes 28 de junio al lunes 04 de julio. Los puntos serán asignados mediante: 
  ...
  - **2 puntos** por nivel de avance, los que se definen de modo comparativo en 5 grupos de trabajos: Terminado (2), muy buen avance (1.5), buen avance (1.0), avance suficiente (0.5), avance insuficiente (0).
